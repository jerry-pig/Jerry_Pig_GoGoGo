...
- **重点卡片**：
  ...
  - [[泰勒展开洋葱法则与势能谐振子微振动]] —— 复合展开交叉项泄露防坑指南与物理极小值谐振子固有频率。
...
- **重点卡片**：
  - [[变上限积分求导与反常积分审敛判定]] —— 变限积分Leibniz求导法则、拆项换元与反常积分p-判别。
...
- **重点卡片**：
  - [[二重积分对称性化简与极坐标变换]] —— 普通奇偶对称性（奇零偶倍）、轮换对称性（对调折半）与极坐标面积微元 $r dr d\theta$ 雅可比本质。
  - [[格林公式环量本质与奇点挖洞法]] —— 二维旋度微元求和、顺逆时针正向法则与奇点破坏连续性时的甜甜圈挖洞形变法。
