...
(3) ① $(0,0)$: $A=-6, C=6 \implies \Delta = -36 < 0$，为\textbf{鞍点}；② $(2,2)$: $A=6, C=-6 \implies \Delta = -36 < 0$，为\textbf{鞍点}；\\
③ $(2,0)$: $A=6, C=6 \implies \Delta = 36 > 0$ 且 $A>0$，为\textbf{极小值点}，极小值 $f(2,0) = -4$；\\
④ $(0,2)$: $A=-6, C=-6 \implies \Delta = 36 > 0$ 且 $A<0$，为\textbf{极大值点}，极大值 $f(0,2) = 4$。
\end{solution}
