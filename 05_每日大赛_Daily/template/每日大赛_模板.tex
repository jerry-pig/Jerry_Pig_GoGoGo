...
\vspace{8pt}
\begin{problem}{Level 1 \textbar\ Basic Execution}{Suggested time: 10\,min}
此处填入基础直算题。旨在建立手感与肌肉记忆。
\end{problem}

\vspace{6pt}
\begin{problem}{Level 2 \textbar\ Advanced Tricks}{Suggested time: 15\,min}
此处填入带有特殊技巧（对称性、补线、换元等）的进阶计算题。
\end{problem}

\vspace{6pt}
\begin{problem}{Level 3 \textbar\ Boss Traps}{Suggested time: 20\,min}
此处填入国科大真题级别的压轴计算，或带有奇点、边界陷阱的极高计算量题目。
\end{problem}
...
\textbf{Level 1:}\enspace
写出基础计算的每一步推导，不要省略中间步骤。

\vspace{2mm}
\textbf{Level 2:}\enspace
指出使用了什么特殊技巧（如奇偶对称性、换元法），并给出详细代数步骤。

\vspace{2mm}
\textbf{Level 3:}\enspace
拆解压轴题的连环陷阱（如奇点挖洞），并提供最简化的推导路线。
\end{solution}
